...
from artificial_hands_py.handover_release_smach.handover_release_smach_base import *
...
class HandoverReleaseSmach(smach.StateMachine):

  def __init__(self, outcomes=['end'], input_keys=..., output_keys=...):
